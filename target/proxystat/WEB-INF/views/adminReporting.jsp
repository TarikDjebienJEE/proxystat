...
<div class="container">
	...
	<section id="statisticsAdmin">
		...
		<div class="hero-unit">
			...
			<hr>
			<p>
				Number of booking predicted for next week :
				<c:out value="<%=numberOfBookingPredictionOfNextWeek%>"></c:out>
				bookings
			</p>
			<p>
				Average amount of booking order :
		...
		<div>
			<a href="#statisticRatingServiceGraphicsArticle"
				data-toggle="collapse">
				<h3>Average rating of service</h3>
				<hr>
			</a>
		</div>
