...
<%-- HTML5 --%>
	...
	<h1><spring:message code="adm.season.create" text=""/></h1>
	<hr>

	<form method="post" action="createNewSeason.admin" class="form-horizontal">
		<fieldset>
			<div class="control-group">
				<label for="name"><spring:message code="adm.season.name" text=""/></label>
				<div>
			...
			<div class="control-group">
				<label for="startDate"><spring:message code="adm.season.start" text=""/></label>
				<div>
			...
			<div class="control-group">
				<label for="endDate"><spring:message code="adm.season.end" text=""/></label>
				<div>
