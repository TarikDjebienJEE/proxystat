...
<div class="container">
	<section id="sectionModifyTrack">
		...
		<h1><spring:message code="adm.meca.price.upd" text=""/></h1>
		<hr>
		...
		<form method="post" action="modifyPass.adminMechanicPartner" class="form-horizontal">
			<fieldset>
				...
				<div class="form-actions">
					<input id="modifyPass_button" value="<spring:message code="adm.modif" text=""/>" type="submit" /> 
		...
		<a id="linkAdminMechanicPartnerToAddPass"
			href="pass.adminMechanicPartner" title=""><spring:message code="adm.return" text=""/></a>
